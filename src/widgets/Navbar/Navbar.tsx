...
const Navbar = () => {
    ...
    // const {sorted} = useAppSelector(state => state.productReducer) TODO Не помню нахуя оно тут, вспомнить)
    const dispatch = useAppDispatch()

    return (
        <div className="h-28 shadow-xl left-0 top-0 w-full bg-myGray px-5 py-3 gap-x-3 flex items-center overflow-x-hidden">
